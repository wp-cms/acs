...
Plugin URI: https://github.com/wp-cms/acs
Update URI: https://plugins.wpcms.dev/acs/info.json
...
class ACS {
	...
	function initialize() {
		...
		add_filter( 'site_transient_update_plugins', array( $this, 'execute_update' ) );
	...
	public function check_plugin_updates(){
		...
		if( false === $remote || ! $this->cache_allowed ) {
			...
			$remote = wp_remote_get(
				'https://plugins.wpcms.dev/acs/info.json',
				array(
					'timeout' => 10,
					'headers' => array(
	...
	function get_plugin_info( $res, $action, $args ) {
		...
		// get updates
		$remote = $this->check_plugin_updates();
	...
	public function execute_update( $transient ) {
