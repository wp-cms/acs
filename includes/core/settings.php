...
class acs_settings{
    ...
    function __construct(){
        ...
        $this->settings = get_option('acs', array());
    ...
    function update(){
        ...
        update_option('acs', $this->settings, 'true');
...
function acs_get_settings($selector = null, $default = null){

    return acs_get_instance('acs_settings')->get($selector, $default);

}

function acs_update_settings($selector = null, $value = null){
    ...
    return acs_get_instance('acs_settings')->set($selector, $value);

}

function acs_delete_settings($selector = null){
    
    return acs_get_instance('acs_settings')->delete($selector);
