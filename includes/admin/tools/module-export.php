...
if(!class_exists('acs_module_export')):

class acs_module_export extends ACS_Admin_Tool{
    ...
    function html_single(){
        ...
        <div class="acs-postbox-columns">
            <div class="acs-postbox-main">
                ...
                <p><?php _e("You can copy and paste the following code to your theme's functions.php file or include it within an external file.", 'acs'); ?></p>
                
                <div id="acs-admin-tool-export">
                    <textarea id="acs-export-textarea" readonly="true"><?php $this->instance->export_php($this->data); ?></textarea>
                </div>
    ...
    function load(){
        ...
        elseif($this->action === 'php'){
            ...
            if(!empty($this->data)){
                ...
                $text = sprintf(_n($this->messages['success_single'], $this->messages['success_multiple'], $count, 'acs' ), $count);
    ...
    function submit(){
        ...
        // validate
        if(!$this->data){
            return acs_add_admin_notice($this->messages['not_selected'], 'warning');
        }
        ...
        if($this->action === 'json'){
            ...
            // file
            $file_name = 'acs-export-' .  $prefix  . '-' . $slugs . '-' .  $date . '.json';
            ...
            // return
            echo acs_json_encode($this->data);
    ...
    function get_keys(){
        ...
        // vars
        $keys_post = acs_maybe_get_POST('keys');
        $keys_get = acs_maybe_get_GET('keys');
        $keys = array();
    ...
    function get_action(){
        ...
        $action = acs_maybe_get_REQUEST('action', $default);
